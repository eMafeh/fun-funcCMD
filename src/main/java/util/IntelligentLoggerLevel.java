...
public class IntelligentLoggerLevel {
     ...
     */
    public static Function<Class<? extends IntelligentLogger>, Boolean> level() {
        return (Function<Class<? extends IntelligentLogger>, Boolean> & Serializable) a -> LEVEL_CACHE.computeIfAbsent(a, c -> DEFAULT_LEVEL) >= ROOT_LEVEL;
    }
    ...
    public static BiConsumer<Class<? extends IntelligentLogger>, Integer> changeLevel() {
        return (BiConsumer<Class<? extends IntelligentLogger>, Integer> & Serializable) (a, b) -> LEVEL_CACHE.computeIfAbsent(a, c -> b);
    }
